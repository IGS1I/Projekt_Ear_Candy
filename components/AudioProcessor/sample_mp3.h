...
/* Tiny test MP3 (silence/beep, ~1 KB) — used to verify the VS10xx MP3 decoder path.
 * Source: https://github.com/baldram/ESP_VS1053_Library */
static const uint8_t kSampleMp3[] = {
...
static const size_t kSampleMp3Size = sizeof(kSampleMp3);
