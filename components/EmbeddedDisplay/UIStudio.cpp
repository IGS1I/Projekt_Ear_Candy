...
#include "UIStudio.h++"
 ...
 class DUI {
   ...
   public:
        DUI(gpio_num_t sda_pin, gpio_num_t scl_pin, gpio_num_t cs_pin, gpio_num_t res_pin, gpio_num_t te_pin, uint16_t w, uint16_t h) 
    ...
    char_write(int16_t x, uint16_t y, char letter, uint16_t color, uint16_t bg, const uint8_t* font) {
